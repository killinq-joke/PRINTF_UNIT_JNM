...
if [ $test_numb -eq $note ] ; then
		...
		echo -e "${SPACER_TOP}\n${SPACER_OK}\n${SPACER_BOT}${NC}\n"
 		...
 		echo -ne "\033[0;31m $note / $test_numb : Error have been found ! see results.log in results/results.log, if errors comes from MIX only, consider moving to Medium test ! \033[0m \n"
...
rm -rf ../*.o ../libftprintf.a ../libft/libft.a
